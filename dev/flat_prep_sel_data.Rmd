...
![Figure 1 : Catch sampling protocol (landed fraction and discarded fraction). The same procedure is implemented separately for the STD trawl and for the TEST trawl](figure/catch_sampling_protocol.png){width="80%"}
