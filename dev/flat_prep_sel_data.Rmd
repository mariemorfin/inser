...
```{r pkg}
# package for reading and rendering tables
library(here)
library(readr)
library(knitr)
```
...
knitr::include_graphics(path = here::here("man","figure","catch_sampling_protocol.png"))
```
...
```{r tr, echo = FALSE}
readr::read_csv(file = here::here("man","table","descriptif_tables-TR.csv"),
...
```{r hh, echo = FALSE}
readr::read_csv(file = here::here("man","table","descriptif_tables-HH.csv"),
                show_col_types = FALSE) %>%
  knitr::kable()
```
...
```{r sl, echo = FALSE}
readr::read_csv(file = here::here("man","table","descriptif_tables-SL.csv"),
                show_col_types = FALSE) %>%
  knitr::kable()
```
...
```{r hl, echo = FALSE}
readr::read_csv(file = here::here("man","table","descriptif_tables-HL.csv"),
                show_col_types = FALSE) %>%
  knitr::kable()
```
