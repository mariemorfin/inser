...
```{r, echo=FALSE,warning=FALSE,comment="",message=FALSE,fig.width=30,fig.height=12,fig.cap=lg[['1_maps_figure']]}

Maps


#cat(lg[['1_figure_maps']])
```
<br/>
...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_duration_caption']],fig.width=5,comment="",message=FALSE,fig.asp=0.5}
