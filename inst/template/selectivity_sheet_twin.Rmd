...
if(length(which(is.na(tab_OP$fishing_duration)==FALSE))>0){
  ...
  geom_boxplot()+labs(y=lg[["1_duration_labs"]])+
...
if(length(which(is.na(tab_OP$gear_depth)==FALSE))>0){
  ...
  geom_boxplot(width=0.2)+labs(y=lg[["1_depth_labs"]])+
...
if(length(which(is.na(tab_OP$gear_speed)==FALSE))>0){
  ...
  geom_boxplot(width=0.2)+labs(y=lg[["1_speed_labs"]])+
...
if(length(which(is.na(tab_OP$sea_state)==FALSE))>0){
  ...
  geom_boxplot(width=0.2)+labs(y=lg[["1_sea_state_labs"]])+
...
if(length(which(is.na(tab_OP$wind_force_beaufort)==FALSE))>0){
  ...
  geom_boxplot(width=0.2)+labs(y=lg[["1_wind_labs"]])+
...
#For each fishing operation and catch category, discards weights difference TEST-STD:
