...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_depth_caption']],comment="",message=FALSE,fig.asp=0.5,fig.width=5}
...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_speed_caption']],comment="",message=FALSE,fig.asp=0.5,fig.width=5}
...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_sea_state_caption']],comment="",message=FALSE,fig.asp=0.5,fig.width=5}
...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_wind_caption']],comment="",message=FALSE,fig.asp=0.5,fig.width=5}
...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_seabed_caption']],comment="",message=FALSE,fig.asp=0.5,fig.width==5}
...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_wind_dir_caption']],comment="",message=FALSE,fig.asp=0.5,fig.width=5}
...
```{r, echo=FALSE,warning=FALSE,fig.cap=lg[['1_day_caption']],comment="",message=FALSE,fig.asp=0.5,fig.width=5}
...
mean_rate<-round(mean(tab_capture$discard_rate)*100)

if(is.na(mean_rate)==FALSE){
  cat(paste0("\n",lg[['2_2_discard_rate']],mean_rate,"%."))
}
